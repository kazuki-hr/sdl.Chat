...
class SoundPlayer {
    ...
    SoundPlayer(Context context) {
        ...
        // https://www2.nhk.or.jp/archives/creative/material/view.cgi?m=D0002011502_00000
        soundSent = soundPool.load(context, R.raw.nhk_uguisu, 1);
    }
    ...
    void playSound() {
        soundPool.play(soundSent, 1.0f, 1.0f, 0, 0, 1);
}
}
